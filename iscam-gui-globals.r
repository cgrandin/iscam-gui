...
.DEFAULT_LINETYPE                <- "1"
.BLOWER_START_YEAR_TEXT          <- "# Blower ref line start year"
.BLOWER_START_YEAR               <- "1971" ## Pcod 2018
.BLOWER_END_YEAR_TEXT            <- "# Blower ref line end year"
.BLOWER_END_YEAR                 <- "1971" ## Pcod 2018
.BUPPER_START_YEAR_TEXT          <- "# Bupper ref line start year"
.BUPPER_START_YEAR               <- "1956" ## Pcod 2018
.BUPPER_END_YEAR_TEXT            <- "# Bupper ref line end year"
.BUPPER_END_YEAR                 <- "2004" ## Pcod 2018
